  ...
  if (isHallWorld) {
    ...
    sceneHotspots = [
      ...
      },
      {
        ...
        radius: 2.55,
        eyebrow: "篝火广场 · 多人社交",
        title: playerSeatedAt === "campfire" ? "你在篝火边（联机中）" : "篝火边的位置还空着",
        prompt: playerSeatedAt === "campfire" ? "篝火边（联机中）" : "在篝火边坐下（联机入口）",
        icon: "users",
        primaryAction: playerSeatedAt === "campfire"
          ? { id: "leave-fire", label: "起身", icon: "door-open" }
          : { id: "sit-by-fire", label: "围炉坐下", icon: "users" },
      },
    ];
